...
contract Ownable {
    ...
    modifier onlyOwner(){
      require(msg.sender == _owner, "Only owner can execute the function!");
      _;
    }
...
contract Pausable is  Ownable{
    ...
    event paused(address setterAddress);
    event unpaused(address setterAddress);
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner != address(0), "The token does not exist!");
        return(owner);
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner,'The address should not be the current owner');
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId),msg.sender),'Caller should be the owner or an approver');
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender,'The messager sender should not be the approver');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0),"The to address is an invalid address");
        // TODO: clear approval
