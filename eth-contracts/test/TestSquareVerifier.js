...
it('It should pass the approval', async function () {
  let verification = await this.contract.verifyTx([proof.proof.a, proof.proof.b, proof.proof.c], proof.inputs);
...
it('It should fail the approval', async function () {
  ...
  let verification = await this.contract.verifyTx([proof.proof.a, proof.proof.b, proof.proof.c], cheat);
